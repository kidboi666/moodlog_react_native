...
import { FullScreenImageModal } from '@/src/shared/components'
import { COLORS, DELAY_MS, LAYOUT } from '@/src/shared/constants'
import { useCardGesture } from '@/src/shared/hooks'
import { BottomSheetType, ISOString, Maybe, MoodName } from '@/src/shared/types'
...
export function JournalCard({
  ...
  return (
    <Animated.View
      entering={FadeIn.delay(delay).duration(DELAY_MS.ANIMATION.LONG)}
