export const en = {
  ...
  onboarding: {
    welcome: {
      title: 'Hello!',
      description:
        'Moodlog is a mood diary app that records and analyzes your daily emotions.',
      description2:
        'Record your emotions daily and discover emotional patterns over time.',
      go: 'Shall we start Moodlog together?',
    },
    nickname: {
      title: 'Your story begins here',
      description: 'What name would you like to use for your story?',
      placeholder: 'Enter your nickname (2-10 characters)',
      helper: 'You can change your nickname at any time in the settings menu.',
      label: 'Nickname',
    },
    personality: {
      ...
      aiPersonality: {
        ...
        description:
          'Choose the level of kindness of the AI that will reply to your diary.',
        rational: {
          title: 'Cool-headed Analyst',
          description: 'Provides objective and practical advice.',
        },
        balanced: {
          title: 'Balanced Advisor',
          description: 'Balances empathy with realistic advice.',
        },
        compassionate: {
          title: 'Compassionate Healer',
          description: 'Offers warm comfort and deep empathy.',
        },
      },
    },
  },
