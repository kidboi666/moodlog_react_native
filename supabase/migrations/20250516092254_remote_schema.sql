...
alter table "public"."user_profiles" add constraint "user_profiles_userId_users_id_fk" FOREIGN KEY ("userId") REFERENCES auth.users(id) ON DELETE CASCADE not valid;

alter table "public"."user_profiles" validate constraint "user_profiles_userId_users_id_fk";
